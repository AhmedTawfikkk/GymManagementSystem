...
namespace GymManagementBLL.ViewModels.MemberViewModels
{
    public class CreateMemberViewModel
    {
        ...
        public int BuildingNumber { get; set; }    // required validation works when the value is null and the int to be null it have to be nullable 
        ...
        // to not make null reference exception when access its properties in the service
        // the validation made on the object first then the propeties inside 
